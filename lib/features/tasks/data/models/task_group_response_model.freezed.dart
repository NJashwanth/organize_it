...
mixin _$TaskGroupResponseModel {
  ...
  $TaskGroupResponseModelCopyWith<TaskGroupResponseModel> get copyWith =>
      _$TaskGroupResponseModelCopyWithImpl<TaskGroupResponseModel>(
          this as TaskGroupResponseModel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is TaskGroupResponseModel &&
  ...
  int get hashCode => Object.hash(runtimeType, id, name, description, createdAt,
      updatedAt, const DeepCollectionEquality().hash(tasks));
...
abstract mixin class $TaskGroupResponseModelCopyWith<$Res> {
  factory $TaskGroupResponseModelCopyWith(TaskGroupResponseModel value,
          $Res Function(TaskGroupResponseModel) _then) =
      _$TaskGroupResponseModelCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      String name,
...
extension TaskGroupResponseModelPatterns on TaskGroupResponseModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TaskGroupResponseModel value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String name, String? description,
            DateTime? createdAt, DateTime? updatedAt, List<TaskModel> tasks)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _TaskGroupResponseModel() when $default != null:
        return $default(_that.id, _that.name, _that.description,
            _that.createdAt, _that.updatedAt, _that.tasks);
      case _:
        return orElse();
    }
  }
...
class _TaskGroupResponseModel implements TaskGroupResponseModel {
  const _TaskGroupResponseModel(
      ...
      : _tasks = tasks;
  factory _TaskGroupResponseModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TaskGroupResponseModelCopyWith<_TaskGroupResponseModel> get copyWith =>
      __$TaskGroupResponseModelCopyWithImpl<_TaskGroupResponseModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$TaskGroupResponseModelToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _TaskGroupResponseModel &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.description, description) ||
                other.description == description) &&
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, name, description, createdAt,
      updatedAt, const DeepCollectionEquality().hash(_tasks));
...
/// @nodoc
abstract mixin class _$TaskGroupResponseModelCopyWith<$Res>
    implements $TaskGroupResponseModelCopyWith<$Res> {
  factory _$TaskGroupResponseModelCopyWith(_TaskGroupResponseModel value,
          $Res Function(_TaskGroupResponseModel) _then) =
      __$TaskGroupResponseModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
